...
def writeALF_Files(sysname,outdir,cgenff):
    ...
    (works with current version of ALF ca. 02/2019)
    """
    ...
    if cgenff:
        ...
        # Is anything different needed if cgenff is not used?
        fp.write("!! Read in toppar stream file\n")
        fp.write("stream @builddir/toppar.str\n\n")
        fp.write("read rtf append card name @builddir/core.rtf\n")
        fp.write("read param flex append card name @builddir/full_ligand.prm\n\n")
...
#####################################################
# Ideas to add:
#  - function to write out a GBSA charmm script for this system
